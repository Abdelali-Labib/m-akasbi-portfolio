...
import { FaCrown, FaFire, FaStar, FaGem, FaImage } from "react-icons/fa";
...
const SkillCard = ({ skill, index, animatedPercentage }) => {
  ...
  return (
    <div 
      ref={ref}
      className="group relative bg-gradient-to-br from-light/95 to-light/90 dark:from-primary/95 dark:to-primary/90 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 border border-accent/20 shadow-xl hover:shadow-2xl hover:border-accent/40 transition-all duration-500 hover:scale-105 flex flex-col h-full"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          ...
          <div className="relative">
            {typeof skill.icon === "string" ? (
              <div className="relative">
                {imageError ? (
                  <div className="h-12 w-12 sm:h-16 sm:w-16 lg:h-18 lg:w-18 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-lg">
                    <FaImage className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400 dark:text-gray-600" />
                  </div>
                ) : (
                  <>
                    {imageLoading && (
                      <div className="absolute inset-0 h-12 w-12 sm:h-16 sm:w-16 lg:h-18 lg:w-18 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-lg">
        ...
        {/* Skill Name - Fixed height to prevent layout shifts */}
        <div className="mb-4 sm:mb-6 flex-shrink-0">
          <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary dark:text-light leading-tight group-hover:text-accent transition-colors duration-300 min-h-[1.5em] line-clamp-2">
            {skill.name}
          </h3>
        </div>

        {/* Enhanced Progress Section - Push to bottom */}
