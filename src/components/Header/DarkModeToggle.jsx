...
export default function DarkModeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="w-12 h-7 bg-gradient-to-r from-accent/30 to-accent/20 rounded-full animate-pulse" />
    );
  }
  ...
  return (
    <button
      onClick={toggleTheme}
      className="group relative w-12 h-7 flex items-center rounded-full bg-gradient-to-r from-accent/30 to-accent/20 dark:from-primary/40 dark:to-primary/60 border border-accent/20 dark:border-primary/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
