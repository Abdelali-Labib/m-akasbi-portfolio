                  ...
                  <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
                    ...
                    <div className="absolute top-3 left-3 z-10">
                      <input
                        ...
                        className="h-5 w-5 rounded border-gray-300 text-accent focus:ring-accent bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm"
                    ...
                    {/* File Type Badge */}
                    <div className="absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-medium bg-white/90 dark:bg-gray-800/90 text-gray-700 dark:text-gray-300 backdrop-blur-sm group-hover:opacity-0 transition-opacity duration-300">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center gap-3 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <button
                        ...
                        className="p-2 bg-white/90 dark:bg-gray-800/90 text-blue-500 rounded-lg hover:bg-white dark:hover:bg-gray-800 transition-colors shadow-sm"
                        title="Copier URL"
                      >
