        ...
        <div key={key} className="bg-white dark:bg-primary/30 p-4 rounded-xl border border-primary/10 dark:border-light/10 shadow-sm">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 border border-primary/20 dark:border-light/20 rounded-lg bg-gray-50 dark:bg-primary/50 text-primary dark:text-light focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all duration-200 font-mono"
        ...
        <div key={key} className="bg-white dark:bg-primary/30 p-4 rounded-xl border border-primary/10 dark:border-light/10 shadow-sm">
          ...
          {isTextArea ? (
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 border border-primary/20 dark:border-light/20 rounded-lg bg-gray-50 dark:bg-primary/50 text-primary dark:text-light focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all duration-200 resize-none"
            ...
            <input
              ...
              value={value}
              onChange={(e) => handleValueChange(currentPath, e.target.value)}
              className="w-full px-4 py-3 border border-primary/20 dark:border-light/20 rounded-lg bg-gray-50 dark:bg-primary/50 text-primary dark:text-light focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all duration-200"
